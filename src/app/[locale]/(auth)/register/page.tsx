  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4 py-12">
      <div className="w-full max-w-[420px] space-y-6">
        ...
        {/* زر العودة المطور: يظهر فوق البطاقة مباشرة */}
        <Link 
          href="/" 
        ...
        <div className="space-y-8 p-6 sm:p-10 border bg-card rounded-3xl shadow-xl shadow-black/5 relative overflow-hidden">
          {/* لمسة جمالية (Gradient Glow) */}
          <div className="absolute -top-10 -right-10 size-32 bg-emerald-500/5 rounded-full blur-3xl" />
          ...
          {/* تذييل البطاقة مع خيار تسجيل الدخول */}
